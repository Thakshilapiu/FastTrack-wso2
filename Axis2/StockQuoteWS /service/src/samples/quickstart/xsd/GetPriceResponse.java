...
/**
 *  GetPriceResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetPriceResponse implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getPriceResponse".equals(type)) {
                            ...
                            return (GetPriceResponse) samples.quickstart.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
